...
Refs: related-work.tex:20; ma2025task.
NOTE 2026-06-06: softened "separate pre-planning step" -> "separate reasoning stage". The added-strategic-
reasoning-layer framing is verified (abstract: Task-level Backward Search + Object Manipulation Constraint
Graph on PDDLStream), but the precise pre-planning timing is unverifiable (paper paywalled, HTTP 402).
Author-approved.
...
================================================================================
NOTE 2026-06-06: results.tex first names \texttt{semantic+mbs0.05} at :72 (Experimental Setup, "Scenes
and seeds") but only defines it at :104 (sec:baselines). Added a brief inline gloss + forward-ref at the
first use: "(the latter forcing a 5\,cm free-space leaf floor; \cref{sec:baselines})". Author-spotted.
Refs: results.tex:72 (sec:setup); results.tex:104 (sec:baselines).

================================================================================
#298  [DONE 2026-06-06] [T2] [THESIS]  Methods: §Overview duplicates the chapter intro's three-component list
================================================================================
NOTE 2026-06-06: methods.tex chapter intro (:6) already lists the three components (adaptive
discretization, formal POD-TAMP model, PDDLStream integration). The following \section{Overview} (:7-13)
restated the same three as a bullet list. Deleted the redundant \section{Overview}; the chapter intro now
goes straight into \section{Adaptive Semantic Discretization}. Author-spotted. No \cref referenced it.
Refs: methods.tex:6-13.

================================================================================
#299  [DONE 2026-06-06] [T2] [THESIS]  Cite Wumpus World at its mention (geffner2013concise)
================================================================================
NOTE 2026-06-06: methods.tex:166 Wumpus-World analogy cited \cite{albore2009translation, geffner2013concise}
lumped at the sentence end (albore = CLG, not about Wumpus). Moved \cite{geffner2013concise} to attach
directly to "Wumpus World" (Geffner & Bonet's book frames Wumpus World in the partial-observability
planning context, Fig 1.1 "Autonomous Behavior in the Wumpus World"); left \cite{albore2009translation}
