...
\paragraph{Resolution regime.} The mbs0.05 null finding holds for the
scene scales tested. It does not generalise to scenes where placements
are constrained by sub-5\,cm geometry; constructing such a scene is the
natural follow-up (\cref{sec:future_work}).
