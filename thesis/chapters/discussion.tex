...
are bundled into a single delta. Both planners are single-threaded, and
TAMPURA's CPU has a marginally higher base clock (2.5 vs 2.0\,GHz), so the
hardware difference, if anything, slightly favours TAMPURA rather than us.
