...
The four streams are short Python procedures over the PyBullet world; their declarative PDDL specifications are listed in \cref{sec:appendix-streams}. Since the planner treats them as black boxes, this section states what each one actually computes.
