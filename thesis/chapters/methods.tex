...
\begin{enumerate}
    \item \textbf{Adaptive Semantic Discretization:} A dynamic procedure for partitioning the robot's workspace into a set of Semantic Boxels, semantically meaningful subspaces, based on detected objects and their known 3D models.
