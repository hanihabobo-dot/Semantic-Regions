...
\paragraph{Software.} PyBullet \cite{coumans2021pybullet}; PDDLStream \cite{garrett2018pddlstream} with the Fast~Downward classical planner backend \cite{helmert2006fast}; Python 3.10.
