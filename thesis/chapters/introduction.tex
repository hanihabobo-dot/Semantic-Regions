...
We want robots that can carry out everyday tasks on their own---fetching an object, clearing a table---tasks that demand both multi-step reasoning and careful physical manipulation. \Ac{tamp} studies how to do exactly this \cite{garrett2018pddlstream, curtis2024partially}.
...
\begin{itemize}
    ...
    \item A Semantic POD-TAMP model that uses Know-If Fluents over Boxels---atoms marking whether a Boxel's contents are known---as a compact belief representation, letting a classical PDDL planner reason about partial observability via optimistic sensing with reactive replanning.
