...
the representation. The scenes studied here are arranged so that, up to the
axis-aligned approximation of the shadow volumes, every place an object
can hide is one such anticipated shadow region; the search-exhausted
failures of \cref{subsec:failure-modes} are the boundary cases this
approximation misses. Extending
