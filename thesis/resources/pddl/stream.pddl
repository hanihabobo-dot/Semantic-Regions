(define (stream boxel-streams)
  ...
  ;; boxel_fits is NOT a stream --- the facts are emitted in the initial
  ;; state.  As a test stream it forced adaptive search to re-evaluate
  ;; every (object, free_boxel) pair across skeletons.
  ...
  ;; Compute IK for stacking ?o on top of ?on_obj.
